...
struct batsman
 {
   char name[25];
   int runs,score,balls,totalRuns,totalBalls,ones,twos,fours,sixes;
 ...
 int plno,choice;
  ...
  for(i=0;i<m;i++)
   ...
   for(i=0;i<n;i++)
   {
       ...
       scanf("%d",&pl2[i].oversBowled);


       printf("Enter the wickets taken by the bowler%d\n",i+1);
       scanf("%d",&pl2[i].wicketsTaken);
     ...
     switch(choice)
      {
        ...
        case 1:
              ...
              pl1[plno].runs=(1*pl1[plno].ones)+(2*pl1[plno].twos)+(4*pl1[plno].fours)+(6*pl1[plno].sixes);
        ...
        case 2:
             ...
             plno--;
              ...
              printf("=================================================================\n");
               ...
               for(i=0;i<n;i++)
               {   pl2[plno].econ=pl2[plno].runsGiven/pl2[plno].oversBowled;
                   printf(" %-15s %-14d %-13d %-11d %-11.2f\n\n",pl2[plno].name,pl2[plno].oversBowled,pl2[plno].runsGiven,pl2[plno].wicketsTaken,pl2[plno].econ);
               }
        ...
        case 3:
              ...
              for(i=0;i<1;i++)
                {
                    pl1[i].runs=(1*pl1[i].ones)+(2*pl1[i].twos)+(4*pl1[i].fours)+(6*pl1[i].sixes);
                    pl3.totalRuns+=pl1[i].runs;
              ...
              printf("=================================================================\n");
               ...
               for(i=0;i<n;i++)
               {   pl2[i].econ=pl2[i].runsGiven/pl2[i].oversBowled;
                   printf(" %-15s %-14d %-13d %-11d %-11.2f\n\n\n",pl2[i].name,pl2[i].oversBowled,pl2[i].runsGiven,pl2[i].wicketsTaken,pl2[i].econ);
               }
        ...
        case 4: pl3.max_run=0,pl4.max_w=0,pl3.max_four=0,pl3.max_six=0;
                ...
                for(i=0;i<m;i++)
                  { 
                     ...
                     if(pl4.max_w<pl2[i].wicketsTaken)
                      {
                      pl4.max_w=pl2[i].wicketsTaken;
                      }
                  }
